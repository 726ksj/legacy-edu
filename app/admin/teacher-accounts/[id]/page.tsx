...
export default async function Page({
  ...
  const account = await getStaffAccountDetail(id, "teacher");
  ...
  return (
    <div className="flex flex-1 flex-col p-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-2">
        <div className="flex flex-col gap-6">
          <div>
            ...
            <div className="mt-3">
              <EditStaffAccountForm role="teacher" account={account} />
            </div>
          </div>
      ...
      <div className="mt-6 max-w-4xl rounded-lg border border-red-200 bg-red-50 p-4">
        ...
        <div className="mt-3">
          <DeleteStaffAccountButton role="teacher" accountId={account.id} />
        </div>
      </div>
    </div>
  );
